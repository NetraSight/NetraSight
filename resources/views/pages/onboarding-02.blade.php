                ...
                <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
                    ...
                    <div class="px-4 py-8">
                        <div class="max-w-md mx-auto">
                            ...
                            <h1 class="text-3xl text-gray-800 dark:text-gray-100 font-bold mb-6">Tell us about your
                                company</h1>
                            <!-- Form -->
                            <form>
                                <div class="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                                    <label class="flex-1 relative block cursor-pointer">
                                        ...
                                        <div
                                            class="h-full text-center bg-white dark:bg-gray-950 px-4 py-6 rounded-lg border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                                            <svg class="inline-flex fill-current text-orange-500 mt-2 mb-4"
                                            ...
                                            <div class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Individual
                                            </div>
                                ...
                                <div class="flex items-center justify-between space-x-6 mb-8">
                                    <div>
                                        <div class="font-medium text-gray-800 dark:text-gray-100 text-sm mb-1">💸 Lorem
                                            ipsum is place text commonly?</div>
                                        <div class="text-xs">Lorem ipsum is placeholder text commonly used in the
                                            graphic, print, and publishing industries for previewing layouts.</div>
                                    </div>
