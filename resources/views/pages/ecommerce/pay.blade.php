            ...
            <header class="bg-white dark:bg-gray-900">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        <a class="block rounded-fullbg-gray-400/20 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                            href="{{ route('cart') }}">
            ...
            <main>
                ...
                <div class="relative pt-8">
                    <div class="absolute inset-0 bg-gray-800 overflow-hidden" aria-hidden="true">
                        <img class="object-cover h-full w-full filter blur opacity-10"
                            src="{{ asset('images/pay-bg.jpg') }}" width="460" height="180" alt="Pay background" />
                    </div>
                    <div class="relative px-4 sm:px-6 lg:px-8 max-w-lg mx-auto">
                        <img class="rounded-t-xl shadow-lg" src="{{ asset('images/pay-bg.jpg') }}" width="460"
                            height="180" alt="Pay background" />
                    </div>
                </div>

                <div class="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto" x-data="{ card: true }">
                    <div class="bg-white dark:bg-gray-950 px-8 pb-6 rounded-b-xl shadow-sm">

                        <!-- Card header -->
                        <div class="text-center mb-6">
                            <div class="mb-2">
                                <img class="-mt-8 inline-flex rounded-full" src="{{ asset('images/user-64-13.jpg') }}"
                                    width="64" height="64" alt="User" />
                            </div>
                            <h1 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-semibold mb-2">
                                Front-End Learning</h1>
                            <div class="text-sm">
                        ...
                        <div class="flex justify-center mb-6">
                            <div class="relative flex w-full p-1 bg-gray-100 dark:bg-gray-700/30 rounded">
                                <span class="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
                                    <span
                                        class="absolute inset-0 w-1/2 bg-white dark:bg-gray-100 rounded-lg border border-gray-200 shadow-sm transition"
                                        :class="card ? 'translate-x-0' : 'translate-x-full'"></span>
                                </span>
                                <button class="relative flex-1 text-sm font-medium text-gray-600 p-1 transition"
                                    :class="card ? 'dark:text-gray-800' : 'dark:text-gray-500'"
                                    @click.prevent="card = true">Pay With Card</button>
                                <button class="relative flex-1 text-sm font-medium text-gray-600 p-1 transition"
                                    :class="!card ? 'dark:text-gray-800' : 'dark:text-gray-500'"
                                    @click.prevent="card = false">Pay With PayPal</button>
                            </div>
                        </div>
                        ...
                        <div x-show="card">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input id="card-nr" class="form-input w-full" type="text"
                                        placeholder="1234 1234 1234 1234" />
                                </div>
                                <!-- Expiry and CVC -->
                                <div class="flex space-x-4">
                                    <div class="flex-1">
                                        <label class="block text-sm font-medium mb-1" for="card-expiry">Expiry Date
                                            <span class="text-red-500">*</span></label>
                                        <input id="card-expiry" class="form-input w-full" type="text"
                                            placeholder="MM/YY" />
                                    </div>
                                    <div class="flex-1">
                                        <label class="block text-sm font-medium mb-1" for="card-cvc">CVC <span
                                                class="text-red-500">*</span></label>
                                        <input id="card-cvc" class="form-input w-full" type="text"
                                            placeholder="CVC" />
                                    </div>
                                </div>
                                <!-- Name on Card -->
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="card-email">Email <span
                                            class="text-red-500">*</span></label>
                                    <input id="card-email" class="form-input w-full" type="email"
                            ...
                            <div class="mt-6">
                                <div class="mb-4">
                                    <button
                                        class="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Pay
                                        $253.00</button>
                                </div>
                                <div class="text-xs text-gray-500 italic text-center">You'll be charged $253, including
                                    $48 for VAT in Italy</div>
                            </div>
                        </div>
