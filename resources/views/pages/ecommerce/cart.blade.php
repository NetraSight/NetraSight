        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div class="mb-6 lg:mb-0">
                <div class="mb-3">
                    <div class="flex text-sm font-medium text-gray-400 dark:text-gray-500 space-x-2">
                        <span class="text-orange-500">Review</span>
                        <span>-&gt;</span>
            ...
            <div class="max-w-sm mx-auto lg:max-w-none">
                <div class="bg-white dark:bg-gray-950 p-5 shadow-sm rounded-xl lg:w-72 xl:w-80">
                    ...
                    <ul class="mb-4">
                        <li
                            class="text-sm w-full flex justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                    ...
                    <div class="mb-4">
                        <button
                            class="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Buy
                            Now - $253.00</button>
                    </div>
                    <div class="text-xs text-gray-500 italic text-center">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do <a class="underline hover:no-underline" href="#0">Terms</a>.</div>
                </div>
            </div>
