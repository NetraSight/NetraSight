        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 lg:grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
            <div class="lg:max-w-[640px] lg:mx-auto">
                ...
                <div class="mb-6 lg:mb-0">
                    ...
                    <header class="mb-2">
                        <!-- Title -->
                        <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Shopping Cart (3)
                        </h1>
                    </header>
                ...
                <div class="py-8 px-4 lg:px-8 2xl:px-12">
                    <div class="max-w-sm mx-auto lg:max-w-none">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Additional Details -->
                            <div>
                                <div class="text-gray-800 dark:text-gray-100 font-semibold mb-4">Additional Details
                                </div>
                                <div class="space-y-4">
                                    <!-- Email -->
                                    <div>
