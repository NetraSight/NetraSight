                            ...
                            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5">
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="grow flex space-x-5">
                                        <button
                                            class="inline-flex items-center text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200">
                                            <svg class="fill-orange-400 mr-2" width="16" height="16"
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white whitespace-nowrap">Send
                                            -&gt;</button>
                                    </div>
                                </div>
                            </div>
