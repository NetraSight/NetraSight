            ...
            <div class="space-y-8 mt-8">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="px-4 py-2 rounded-lg text-sm bg-yellow-500 text-white">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current opacity-80 mt-[3px] mr-3" width="16"
                                            height="16" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 12c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm1-3H7V4h2v5z" />
                                        </svg>
                                        <div class="font-medium">We're currently experiencing an increase in inquiries.
                                            There may be a delay in responses from the Support.</div>
                                    </div>
                            ...
                            <div class="px-4 py-2 rounded-lg text-sm bg-green-500 text-white">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        ...
                                        <div class="font-medium">All Systems are operational. Sorry for any
                                            inconvenience this might cause!</div>
                                    </div>
                                    <button class="opacity-60 hover:opacity-70 ml-3 mt-[3px]" @click="open = false">
                                        <div class="sr-only">Close</div>
                                        <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <div class="px-4 py-2 rounded-lg text-sm bg-red-500 text-white">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        ...
                                        <div class="font-medium">Customers are experiencing a delay in withdrawing their
                                            funds!</div>
                                    </div>
                                    <button class="opacity-60 hover:opacity-70 ml-3 mt-[3px]" @click="open = false">
                                        <div class="sr-only">Close</div>
                        ...
                        <!-- Start -->
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="px-4 py-2 rounded-lg text-sm bg-orange-500 text-white">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current opacity-80 mt-[3px] mr-3" width="16"
                                            height="16" viewBox="0 0 16 16">
                    ...
                    <div class="space-y-3">
                            ...
                            <div class="px-4 py-2 rounded-lg text-sm bg-yellow-100 text-gray-700">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        ...
                                        <div>We're currently experiencing an increase in inquiries. There may be a delay
                                            in responses from the Support.</div>
                                    </div>
                                    <button class="opacity-60 hover:opacity-70 ml-3 mt-[3px]" @click="open = false">
                                        <div class="sr-only">Close</div>
                                        <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="px-4 py-2 rounded-lg text-sm bg-green-100 text-gray-700">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-green-500 mt-[3px] mr-3" width="16"
                                            height="16" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zM7 11.4L3.6 8 5 6.6l2 2 4-4L12.4 6 7 11.4z" />
                                        </svg>
                                        <div>All Systems are operational. Sorry for any inconvenience this might cause!
                                        </div>
                                    </div>
                                    <button class="opacity-60 hover:opacity-70 ml-3 mt-[3px]" @click="open = false">
                                        <div class="sr-only">Close</div>
                        ...
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="px-4 py-2 rounded-lg text-sm bg-red-100 text-gray-700">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-red-500 mt-[3px] mr-3" width="16"
                                            height="16" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm3.5 10.1l-1.4 1.4L8 9.4l-2.1 2.1-1.4-1.4L6.6 8 4.5 5.9l1.4-1.4L8 6.6l2.1-2.1 1.4 1.4L9.4 8l2.1 2.1z" />
                                        </svg>
                        ...
                        <!-- Start -->
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="px-4 py-2 rounded-lg text-sm bg-orange-100 text-gray-700">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-orange-500 mt-[3px] mr-3"
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <!-- Start -->
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="inline-flex min-w-80 px-4 py-2 rounded-lg text-sm bg-orange-500 text-white">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current opacity-80 mt-[3px] mr-3" width="16"
                                            height="16" viewBox="0 0 16 16">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <!-- Start -->
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div class="inline-flex min-w-80 px-4 py-2 rounded-lg text-sm bg-orange-100 text-gray-700">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-orange-500 mt-[3px] mr-3"
                                            width="16" height="16" viewBox="0 0 16 16">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div
                                class="inline-flex min-w-80 px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-950 shadow-sm border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-100">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-yellow-500 mt-[3px] mr-3"
                                            width="16" height="16" viewBox="0 0 16 16">
                                    ...
                                    <button class="dark:text-gray-400 opacity-60 hover:opacity-70 ml-3 mt-[3px]"
                                        @click="open = false">
                                        <div class="sr-only">Close</div>
                                        <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16">
                                            <path
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div x-show="open" x-data="{ open: true }" role="alert">
                            <div
                                class="inline-flex flex-col w-full max-w-lg px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-950 shadow-sm border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-400">
                                <div class="flex w-full justify-between items-start">
                                    <div class="flex">
                                        <svg class="shrink-0 fill-current text-yellow-500 mt-[3px] mr-3"
                                            width="16" height="16" viewBox="0 0 16 16">
                                        ...
                                        <div>
                                            <div class="font-medium text-gray-800 dark:text-gray-100 mb-1">Merged Pull
                                                Request</div>
                                            <div>Lorem ipsum dolor sit amet, consectetur adipiscing sed do eiusmod
