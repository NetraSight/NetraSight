                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="relative ml-2" x-data="{ open: false }" @mouseenter="open = true"
                                        ...
                                        <div class="z-10 absolute bottom-full left-1/2 -translate-x-1/2">
                                            <div class="min-w-60 bg-gray-800 text-gray-200 px-2 py-1 rounded overflow-hidden mb-2"
                                                x-show="open"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                                        <span
                                            class="text-sm text-gray-400 dark:text-gray-500 font-medium px-3">USD</span>
                                    </div>
                                </div>
                            </div>
                            <!-- End -->
                        ...
                        <div>
                            ...
                            <form>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                                        <svg class="fill-current text-gray-400 dark:text-gray-500 shrink-0 ml-3 mr-2"
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input id="disabled"
                                    class="form-input w-full dark:disabled:placeholder:text-gray-600 disabled:border-gray-200 dark:disabled:border-gray-700 disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:text-gray-400 dark:disabled:text-gray-600 disabled:cursor-not-allowed shadow-none"
                            ...
                            <div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="success">Success <span
                                            class="text-red-500">*</span></label>
                                    <input id="success" class="form-input w-full border-green-300"
                                        type="text" />
                                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center -m-3">
                        ...
                        <div class="m-3">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox"
                                    class="form-checkbox disabled:border-gray-200 dark:disabled:border-gray-700 disabled:bg-gray-100 dark:disabled:bg-gray-800"
                                    disabled />
                        ...
                        <div class="m-3">
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="radio-buttons"
                                    class="form-radio disabled:border-gray-200 dark:disabled:border-gray-700 disabled:bg-gray-100 dark:disabled:bg-gray-800"
                                    disabled />
                                <span class="text-sm ml-2">Disabled</span>
                            </label>
                            <!-- End -->
