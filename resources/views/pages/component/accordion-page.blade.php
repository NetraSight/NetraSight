    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div>
            ...
            <div class="space-y-8 mt-8">
                ...
                <div>
                    ...
                    <div class="px-5 py-4 rounded-lg border border-gray-200 dark:border-gray-700/60"
                        ...
                        <button class="flex items-center justify-between w-full group mb-1"
                            ...
                            <svg class="w-8 h-8 shrink-0 fill-current text-gray-400 dark:text-gray-500 group-hover:text-gray-500 dark:group-hover:text-gray-400 ml-3"
                                ...
                                <tbody class="text-sm" x-data="{ open: false }">
                                    ...
                                    <tr>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center text-gray-800">
                                                <div
                                                    class="w-10 h-10 shrink-0 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded-full mr-2 sm:mr-3">
                                                    <img class="rounded-full ml-1"
                                                        src="{{ asset('images/user-40-07.jpg') }}" width="40"
                                                        height="40" alt="User 01" />
                                                </div>
                                                <div class="font-medium text-gray-800 dark:text-gray-100">Mark Cameron
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div
                                                class="inline-flex font-medium bg-yellow-500/20 text-yellow-700 rounded-full text-center px-2.5 py-0.5">
                                                Refunded</div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <svg class="fill-current text-gray-400 dark:text-gray-500 shrink-0 mr-2"
                                    ...
                                    <tr id="description-01" role="region" x-show="open" x-cloak>
                                        <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
                                            <div
                                                class="flex items-center bg-gray-50 dark:bg-gray-950/[0.15] dark:text-gray-400 p-3 -mt-3">
                                                ...
                                                <div class="italic">Excepteur sint occaecat cupidatat non proident, sunt
                ...
                <div>
                    <h2 class="text-2xl text-gray-800 dark:text-gray-100 font-bold mb-6">Rich Table Row with Accordion
                    </h2>
                    <!-- Start -->
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700/60">
                        <div class="overflow-x-auto">
                            <table
                                ...
                                <tbody class="text-sm" x-data="{ open: false }">
                                    ...
                                    <tr id="description-01" role="region" x-show="open" x-cloak>
                                        <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
                                            <div
                                                class="bg-gray-50 dark:bg-gray-950/[0.15] dark:text-gray-400 p-3 -mt-3">
                                                ...
                                                <button
                                                    class="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Approve</button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
