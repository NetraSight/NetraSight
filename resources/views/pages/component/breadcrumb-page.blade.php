                    ...
                    <div class="px-6 py-8 bg-gray-100 dark:bg-gray-950/50 rounded-lg">
                        <div class="text-center">
                            ...
                            <ul class="inline-flex flex-wrap text-sm font-medium">
                                <li
                                    class="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                        ...
                        <div class="text-center">
                            ...
                            <ul class="inline-flex flex-wrap text-sm font-medium">
                                <li class="flex items-center">
                                    <a class="text-gray-500 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-500"
                                        href="#0">Home</a>
                                    <svg class="fill-current text-gray-400 dark:text-gray-600 mx-3" width="16"
