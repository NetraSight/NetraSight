<x-app-layout background="bg-white dark:bg-gray-900" headerVariant="v3" sidebarVariant="v2">
    <div class="lg:relative lg:flex">
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="mb-5">
                <ul class="flex flex-wrap -m-1">
                    ...
                    <li class="m-1">
                        <button
                            class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-950 text-gray-500 dark:text-gray-400 transition">Physical
                            Cards</button>
                    </li>
                    <li class="m-1">
                        <button
                            class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-950 text-gray-500 dark:text-gray-400 transition">Virtual
                            Cards</button>
                    </li>
                </ul>
            </div>
            ...
            <div class="space-y-2">
                ...
                <label class="relative block cursor-pointer text-left w-full">
                    ...
                    <div
                        class="p-4 rounded-lg dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                        <div class="grid grid-cols-12 items-center gap-x-2">
                            ...
                            <div
                                ...
                                <svg class="shrink-0" width="32" height="24" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        <linearGradient x1="1.829%" y1="100%" x2="100%" y2="2.925%"
                                            id="c1-a">
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        ...
                                        <ellipse fill="#E61C24" fill-rule="nonzero" cx="12.522" cy="12"
                                            rx="5.565" ry="5.647" />
                                        <ellipse fill="#F99F1B" fill-rule="nonzero" cx="19.432" cy="12"
                                            rx="5.565" ry="5.647" />
                                        <path
                            ...
                            <div
                                ...
                                <div class="text-sm font-medium text-gray-800 dark:text-gray-100 truncate">Dominik
                                    Lamakani</div>
                            </div>
                            <!-- Card limits -->
                            <div
        ...
        <div>
            <div
                class="lg:sticky lg:top-16 bg-gradient-to-b from-gray-100 to-white dark:from-gray-800/30 dark:to-gray-900 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700/60 lg:w-[390px] lg:h-[calc(100dvh-64px)]">
                <div class="py-8 px-4 lg:px-8">
                    <div class="max-w-sm mx-auto lg:max-w-none">

                        <div class="text-gray-800 dark:text-gray-100 font-semibold text-center mb-6">Physical Metal
                            Card Summary</div>

                        <!-- Credit Card -->
                        <div
                            class="relative aspect-[7/4] bg-gradient-to-tr from-gray-900 to-gray-800 p-5 rounded-xl overflow-hidden">
                            <div class="relative h-full flex flex-col justify-between">
                                ...
                                <svg width="32" height="32" viewBox="0 0 32 32"
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient x1="50%" y1="24.537%" x2="50%" y2="99.142%"
                                            id="icon1-c">
                                ...
                                <!-- Card number -->
                                <div
                                    class="flex justify-between text-lg font-bold text-gray-200 tracking-widest drop-shadow-md">
                                    <span>****</span>
                                    <span>****</span>
                                    <span>****</span>
                                    <span>7328</span>
                                ...
                                <div class="relative flex justify-between items-center z-10 mb-0.5">
                                    <!-- Card expiration -->
                                    <div
                                        class="text-sm font-bold text-gray-200 tracking-widest drop-shadow-md space-x-3">
                                        <span>EXP 12/24</span>
                                        <span>CVC ***</span>
                                    </div>
                                </div>
                        ...
                        <div class="mt-6">
                            ...
                            <ul>
                                <li
                                    ...
                                    <div class="text-sm font-medium text-gray-800 dark:text-gray-100 ml-2">Physical
                                        Metal Card</div>
                                </li>
                                <li
                                    class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700/60">
                        ...
                        <!-- Payment Limits -->
                        <div class="mt-6">
                            <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Payment Limits
                            </div>
                            <div class="pb-4 border-b border-gray-200 dark:border-gray-700/60">
                                <div class="flex justify-between text-sm mb-2">
                                    <div>Spent This Month</div>
                                    <div class="italic">$750,00 <span
                                            class="text-gray-400 dark:text-gray-500">/</span> $1,500.00</div>
                                </div>
                                <div class="relative w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
                                    <div class="absolute inset-0 bg-green-400 rounded-full" aria-hidden="true"
                                        style="width: 50%;"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Withdrawal Limits -->
                        <div class="mt-6">
                            <div class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Withdrawal Limits
                            </div>
                            <div class="pb-4 border-b border-gray-200 dark:border-gray-700/60">
                                <div class="flex justify-between text-sm mb-2">
                                    <div>Withdrawn This Month</div>
                                    <div class="italic">$100,00 <span
                                            class="text-gray-400 dark:text-gray-500">/</span> $1,500.00</div>
                                </div>
                                <div class="relative w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
                                    <div class="absolute inset-0 bg-green-400 rounded-full" aria-hidden="true"
                        ...
                        <div class="flex items-center space-x-3 mt-6">
                            ...
                            <div class="w-1/2">
                                <button
                                    class="btn w-full border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-red-500">
