<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <!-- Post a job button -->
            <button
                class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Post
                A Job</button>
            ...
            <div class="w-full">
                ...
                <div class="mb-5">
                    <form class="relative">
                        ...
                        <input id="job-search" class="form-input w-full pl-9 bg-white dark:bg-gray-950" type="search"
                        ...
                        <div class="relative inline-flex" x-data="{ open: false }">
                            <button class="inline-flex justify-center items-center group" aria-haspopup="true"
                                ...
                                <div class="flex items-center truncate">
                                    <span
                                        class="truncate font-medium text-orange-500 group-hover:text-orange-600 dark:group-hover:text-orange-400">Newest</span>
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-orange-400" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </button>
                            <div class="origin-top-right z-10 absolute top-full right-0 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
