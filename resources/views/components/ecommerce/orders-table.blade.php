<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">All Orders <span
                class="text-gray-400 dark:text-gray-500 font-medium">{{ $count }}</span></h2>
    </header>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center text-gray-800">
                                    <div
                                        ...
                                        <img class="ml-1" src="{{ asset('images/' . $order->image) }}" width="20"
                                            height="20" alt="{{ $order->order }}" />
                                    </div>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center">
                                    <button
                                        ...
                                        :aria-expanded="open" aria-controls="description-{{ $order->id }}">
                                        <span class="sr-only">Menu</span>
