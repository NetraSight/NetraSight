...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-950 shadow-sm rounded-xl overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-13.jpg') }}" width="286" height="160"
                alt="Application 13" />
            <!-- Like button -->
        ...
        <div class="grow flex flex-col p-5">
            ...
            <div class="grow">
                <!-- Header -->
                <header class="mb-4">
                    <a class="text-xs text-green-500 hover:text-green-600 font-semibold uppercase tracking-widest mb-1"
                        href="#0">Funding</a>
                ...
                <div class="mb-5">
                    <div class="flex justify-between text-sm space-x-2 mb-2">
                        <div><span class="font-semibold text-gray-800 dark:text-gray-100">$789,784</span> <span
                                class="italic">raised</span></div>
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-950 shadow-sm rounded-xl overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-14.jpg') }}" width="286" height="160"
                alt="Application 14" />
            <!-- Like button -->
            <button class="absolute top-0 right-0 mt-4 mr-4">
                <div class="text-gray-100 bg-gray-900 bg-opacity-60 rounded-full">
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-950 shadow-sm rounded-xl overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-15.jpg') }}" width="286" height="160"
                alt="Application 15" />
            <!-- Like button -->
            <button class="absolute top-0 right-0 mt-4 mr-4">
                <div class="text-gray-100 bg-gray-900 bg-opacity-60 rounded-full">
...
<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-950 shadow-sm rounded-xl overflow-hidden">
    <div class="flex flex-col h-full">
        <!-- Image -->
        <div class="relative">
            <img class="w-full" src="{{ asset('images/applications-image-16.jpg') }}" width="286" height="160"
                alt="Application 16" />
            <!-- Like button -->
            <button class="absolute top-0 right-0 mt-4 mr-4">
                <div class="text-gray-100 bg-gray-900 bg-opacity-60 rounded-full">
        ...
        <div class="grow flex flex-col p-5">
            ...
            <div class="grow">
                ...
                <div class="mb-5">
                    ...
                    <!-- Bar -->
                    <div class="relative w-full h-2 rounded-full bg-gray-200 dark:bg-gray-700 mb-2">
                        <div class="absolute left-0 top-0 bottom-0 bg-green-500 rounded-full" style="width:55%;">
                        </div>
                    </div>
                    <div class="font-medium text-xs text-gray-500 dark:text-gray-400">30 Days Left</div>
                </div>
