<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">All Customers <span
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center relative">
                                    <button>
                                        <svg class="shrink-0 fill-current @if ($customer->fav) {{ 'text-yellow-500' }}@else{{ 'text-gray-300 dark:text-gray-600' }} @endif"
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 shrink-0 mr-2 sm:mr-3">
                                        <img class="rounded-full" src="{{ asset('images/' . $customer->image) }}"
                                            width="40" height="40" alt="{{ $customer->name }}" />
                                    </div>
                                    <div class="font-medium text-gray-800 dark:text-gray-100">{{ $customer->name }}
                                    </div>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-center">
                                    @if ($customer->refunds > 0)
                                        {{ $customer->refunds }}@else{{ '-' }}
                                    @endif
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
