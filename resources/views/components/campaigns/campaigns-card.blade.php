...
<div class="col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    <div class="flex flex-col h-full p-5">
        <header>
            <div class="flex items-center justify-between">
                ...
                @elseif ($campaign->category === '4')
                    <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-orange-500">
                        <svg class="w-9 h-9 fill-current text-white" viewBox="0 0 36 36">
                            <path
        ...
        <div class="grow mt-2">
            <a class="inline-flex text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white mb-1"
                href="#0">
        ...
        <footer class="mt-5">
            <div class="text-sm font-medium text-gray-500 mb-2">
                ...
                {{ \Carbon\Carbon::parse($campaign->end_date)->format('M j') }}</div>
