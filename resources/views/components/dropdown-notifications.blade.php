...
<div class="relative inline-flex" x-data="{ open: false }">
    <button
        ...
        :class="{ 'bg-gray-200 dark:bg-gray-950': open }" aria-haspopup="true" @click.prevent="open = !open"
        :aria-expanded="open">
    ...
    <div class="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 {{ $align === 'right' ? 'right-0' : 'left-0' }}"
        ...
        <ul>
            <li class="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
                <a class="block py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-700/20" href="#0"
                    ...
                    <span class="block text-sm mb-2">📣 <span class="font-medium text-gray-800 dark:text-gray-100">Edit
