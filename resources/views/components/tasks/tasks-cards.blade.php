...
<div class="col-span-full sm:col-span-6 xl:col-span-3">
    ...
    <header>
        <div class="flex items-center justify-between mb-2">
            ...
            <button class="shrink-0 text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 ml-2">
        ...
        <div class="grid gap-2">
            ...
            <!-- Card 1 -->
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                <!-- Body -->
                <div class="mb-3">
                    <!-- Title -->
                    ...
                    <!-- Content -->
                    <div>
                        <div class="text-sm">#7764 created by <a class="font-medium text-gray-800 hover:underline"
                                href="#0">markus-james</a></div>
                    </div>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-07.jpg') }}"" width="28" height="28"
                                alt="User 07" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-11.jpg') }}"" width="28" height="28"
                                alt="User 11" />
                        </a>
                    </div>
                    <!-- Right side -->
                    <div class="flex items-center">
                        <!-- Like button -->
                        <button
                            class="flex items-center text-gray-400 dark:text-gray-500 hover:text-orange-500  dark:hover:text-orange-500 ml-3">
                        ...
                        <!-- Attach button -->
                        <button
                            class="text-gray-400 dark:text-gray-500 hover:text-orange-500  dark:hover:text-orange-500 ml-3">
                            <svg class="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
                                <path
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">User should receive a daily digest
                        email</h2>
                    <!-- Content -->
                    <div>
                ...
                <div class="flex items-center justify-between">
                    <!-- Left side -->
                    <button
                        class="p-2 shrink-0 rounded-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-orange-500 transition">
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    <!-- Title -->
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Change license and remove references
                        to products</h2>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-03.jpg') }}"" width="28" height="28"
                                alt="User 03" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-10.jpg') }}"" width="28" height="28"
                                alt="User 10" />
                        </a>
                    </div>
                    <!-- Right side -->
                    <div class="flex items-center">
                        ...
                        <button
                            class="flex items-center text-gray-400 dark:text-gray-500 hover:text-orange-500  dark:hover:text-orange-500 ml-3">
                            <svg class="shrink-0 fill-current mr-1.5" width="16" height="16"
                                viewBox="0 0 16 16">
                                <path
                                    d="M8 0C3.6 0 0 3.1 0 7s3.6 7 8 7h.6l5.4 2v-4.4c1.2-1.2 2-2.8 2-4.6 0-3.9-3.6-7-8-7zm4 10.8v2.3L8.9 12H8c-3.3 0-6-2.2-6-5s2.7-5 6-5 6 2.2 6 5c0 2.2-2 3.8-2 3.8z" />
                            </svg>
        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-06.jpg') }}"" width="28" height="28"
                                alt="User 06" />
                        </a>
                    </div>
                    <!-- Right side -->
                ...
                <ul class="mt-3">
                    ...
                    <li class="flex items-center border-t border-gray-100 dark:border-gray-700/60 py-2">
                        <svg class="w-3 h-3 shrink-0 fill-current text-gray-400 dark:text-gray-500 mr-2"
                            viewBox="0 0 12 12">
                            <path
                                d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
                        </svg>
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <div class="text-sm">Dedicated form for a category of users that will perform actions.</div>
                        <img class="w-full mt-3" src="{{ asset('images/task-image-01.jpg') }}"" width="259"
                            height="142" alt="Task 01" />
                    </div>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-05.jpg') }}"" width="28" height="28"
                                alt="User 05" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-02.jpg') }}"" width="28" height="28"
                                alt="User 02" />
                        </a>
                    </div>
                    <!-- Right side -->
        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    ...
                    <!-- Content -->
                    <div>
                        <div class="text-sm">#7896 created by <a class="font-medium text-gray-800 hover:underline"
                                href="#0">jerzy-wierzy</a></div>
                    </div>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-12.jpg') }}"" width="28" height="28"
                                alt="User 12" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                src="{{ asset('images/user-28-08.jpg') }}"" width="28" height="28"
                                alt="User 08" />
                        </a>
                    </div>
                    <!-- Right side -->
                ...
                <ul class="mt-3">
                    <li class="flex items-center border-t border-gray-100 dark:border-gray-700/60 py-2">
                        ...
                        <div class="text-sm text-gray-400 dark:text-gray-500 line-through">Call with incoming clients
                        </div>
                    </li>
                    <li class="flex items-center border-t border-gray-100 dark:border-gray-700/60 py-2">
                        <svg class="w-3 h-3 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 12 12">
        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <div class="grow">
                            <a class="inline-flex text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white"
                                href="#0">
                    ...
                    <!-- Content -->
                    <div>
                        <div class="text-sm">Publishing industries for previewing layouts and visual <a
                                class="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400"
                                href="#0">#family</a> 🔥</div>
                        <img class="w-full mt-3" src="{{ asset('images/task-image-02.jpg') }}"" width="259"
                            height="142" alt="Task 02" />
                    </div>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
            ...
            <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-4">
                ...
                <div class="mb-3">
                    ...
                    <!-- Content -->
                    <div>
                        <div class="text-sm">Dedicated form for a category of users that will perform actions? <a
                                class="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400"
                                href="#0">#viewall</a></div>
                    </div>
                </div>
                <!-- Footer -->
                <div class="flex items-center justify-between">
