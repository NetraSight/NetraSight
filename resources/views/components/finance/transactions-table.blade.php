    ...
    <div x-data="handleSelect">
        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full dark:text-gray-300" @click.stop="$dispatch('set-transactionopen', true)">
                <!-- Table header -->
                <thead
                    class="text-xs font-semibold uppercase text-gray-500 border-t border-b border-gray-200 dark:border-gray-700/60">
                    <tr>
                ...
                <!-- Table body -->
                <tbody
                    class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60 border-b border-gray-200 dark:border-gray-700/60">
                    <!-- Row -->
                                ...
                                <div class="flex items-center">
                                    <div class="w-9 h-9 shrink-0 mr-2 sm:mr-3">
                                        <img class="w-9 h-9 rounded-full"
                                            src="{{ asset('images/' . $transaction->image) }}" width="36"
                                            height="36" alt="{{ $transaction->name }}" />
                                    </div>
                                    <div class="font-medium text-gray-800 dark:text-gray-100">{{ $transaction->name }}
                                    </div>
                                </div>
                            </td>
