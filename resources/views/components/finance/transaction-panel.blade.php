...
<div class="absolute inset-0 sm:left-auto z-20 shadow-xl duration-200 ease-in-out"
    ...
    <div
        class="sticky top-16 bg-gradient-to-b from-gray-100 to-white dark:from-[#151D2C] dark:to-gray-900 overflow-x-hidden overflow-y-auto no-scrollbar shrink-0 border-l border-gray-200 dark:border-gray-700/60 w-full sm:w-[390px] h-[calc(100dvh-64px)]">

        <button class="absolute top-0 right-0 mt-6 mr-6 group p-2" @click="transactionOpen = false">
            <svg class="fill-gray-400 group-hover:fill-gray-600" width="16" height="16" viewBox="0 0 16 16"
        ...
        <div class="py-8 px-4 lg:px-8">
            <div class="max-w-sm mx-auto lg:max-w-none">
                ...
                <div class="drop-shadow-md mt-12">
                    <!-- Top -->
                    <div class="bg-white dark:bg-gray-950 rounded-t-xl px-5 pb-2.5 text-center">
                    ...
                    <div class="flex justify-between items-center" aria-hidden="true">
                        <svg class="fill-white dark:fill-gray-800" width="20"
                            height="20"xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 20c5.523 0 10-4.477 10-10S5.523 0 0 0h20v20H0Z" />
                        </svg>
                        <div class="grow w-full h-5 bg-white dark:bg-gray-950 flex flex-col justify-center">
                            <div class="h-px w-full border-t border-dashed border-gray-200 dark:border-gray-700"></div>
                        </div>
                        <svg class="fill-white dark:fill-gray-800 rotate-180" width="20" height="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 20c5.523 0 10-4.477 10-10S5.523 0 0 0h20v20H0Z" />
                        </svg>
                    </div>
                    <!-- Bottom -->
                    <div class="bg-white dark:bg-gray-950 rounded-b-xl p-5 pt-2.5 text-sm space-y-3">
                        <div class="flex justify-between space-x-1">
                            <span class="italic">IBAN:</span>
                            <span class="font-medium text-gray-700 dark:text-gray-100 text-right">IT17 2207 1010 0504
                                0006 88</span>
                        </div>
                        <div class="flex justify-between space-x-1">
                ...
                <div class="mt-6">
                    ...
                    <form
                        class="rounded bg-gray-100 dark:bg-gray-700/30 border border-dashed border-gray-300 dark:border-gray-700/60 text-center px-5 py-8">
                        <svg class="inline-flex fill-gray-400 dark:fill-gray-500 mb-3" width="16" height="16"
                            viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8 4c-.3 0-.5.1-.7.3L1.6 10 3 11.4l4-4V16h2V7.4l4 4 1.4-1.4-5.7-5.7C8.5 4.1 8.3 4 8 4ZM1 2h14V0H1v2Z" />
                        </svg>
                        <label for="upload" class="block text-sm text-gray-500 dark:text-gray-400 italic">We accept
                            PNG, JPEG, and PDF files.</label>
                ...
                <div class="flex items-center space-x-3 mt-6">
                    <div class="w-1/2">
                        <button
                            ...
                            <svg class="fill-current text-gray-400 dark:text-gray-500 shrink-0 rotate-180"
