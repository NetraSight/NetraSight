<div class="space-y-8">
    <!-- Alert -->
    <div
        class="relative bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-orange-500/[0.12] dark:from-orange-500/[0.24] to-orange-500/[0.04] rounded-lg p-5">
        ...
        <div class="relative">
            <div class="text-sm font-medium text-gray-800 dark:text-orange-200 mb-2">Remember to keep track of your job
                research.</div>
            <div class="text-right">
                <a class="text-sm font-medium text-orange-500 hover:text-orange-600" href="#0">Create Alert
                    -&gt;</a>
            </div>
        </div>
    </div>
    <!-- White box -->
    <div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5 min-w-60">
        <div class="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Management /
                                Finance</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Customer
                                Support</span>
                        </label>
                    </li>
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Sales /
                                Marketing</span>
                        </label>
                    </li>
                </ul>
            ...
            <div>
                ...
                <div class="flex items-center" x-data="{ checked: true }">
                    ...
                    <div class="text-sm text-gray-400 dark:text-gray-500 italic ml-2" x-text="checked ? 'On' : 'Off'">
                    </div>
                </div>
                <div class="text-sm dark:text-gray-500 italic mt-3">Only show companies that are creating a positive
                    culture</div>
            </div>
            <!-- Group 3 -->
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <label class="flex items-center">
                            <input type="checkbox" class="form-checkbox" />
                            <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Drawing /
                                Painting</span>
                        </label>
                    </li>
                </ul>
