<div class="col-span-full xl:col-span-6 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    ...
    <div class="p-3">
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="shrink-0 rounded-full mr-2 sm:mr-3">
                                    <img class="w-9 h-9 rounded-full" src="{{ asset('images/user-36-05.jpg') }}"
                                        width="36" height="36" alt="User 05" />
                                </div>
        ...
        <div class="text-center border-t border-gray-100 dark:border-gray-700/60 px-2">
            <a class="block text-sm font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 pt-4 pb-1"
                href="#0">View All -&gt;</a>
        </div>
