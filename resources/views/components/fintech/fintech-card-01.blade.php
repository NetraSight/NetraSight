<div class="flex flex-col col-span-full xl:col-span-8 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
        ...
        <div class="flex flex-wrap justify-between items-end gap-y-2 gap-x-4">
            <div class="flex items-center">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400"><span
                        class="font-medium text-gray-800 dark:text-gray-100">17.4%</span> AVG</div>
            </div>
