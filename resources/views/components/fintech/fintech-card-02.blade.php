<div
    class="flex flex-col col-span-full xl:col-span-4 bg-[linear-gradient(225deg,var(--tw-gradient-stops))] from-gray-800 to-gray-900 shadow-sm rounded-xl">
        ...
        <div class="relative w-full max-w-sm mx-auto bg-gray-700/50 p-2.5 rounded-2xl">
            ...
            <div class="absolute top-0 right-0 inline-flex" x-data="{ open: false }">
                <button class="rounded-full"
                    :class="open ? 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300' :
            ...
            <div class="space-y-2">
                <div>
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <div class="text-gray-400 italic">$780,00 <span
                                class="text-gray-500 dark:text-gray-400">/</span> $1,500.00</div>
                    </div>
                ...
                <div>
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <div class="text-gray-400 italic">$179,00 <span
                                class="text-gray-500 dark:text-gray-400">/</span> $1,000.00</div>
                    </div>
                    <div class="relative w-full h-2 bg-gray-600 rounded">
                        <div class="absolute inset-0 bg-green-400 rounded-full" aria-hidden="true"
                            style="width: 35%;"></div>
