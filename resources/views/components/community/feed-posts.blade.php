<!-- Post 1 -->
<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5">
    <!-- Header -->
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="{{ asset('images/user-40-03.jpg') }}" width="40" height="40"
                alt="User 03" />
            <div>
        ...
        <div class="relative">
            <div class="absolute top-0 right-0 inline-flex" x-data="{ open: false }">
                ...
                <div class="origin-top-right z-10 absolute top-full right-0 min-w-36 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
    ...
    <div class="text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-5">
        <p>👋</p>
        <p>It's more likely that people reading your blog will opt in with their email addresses if you give them
            something highly relevant in return. Ditch that too-general lead magnet and create "content upgrades" for
            your highest-traffic articles.</p>
        <p>Thread 👇</p>
    </div>
    <!-- Footer -->
    <footer class="flex items-center space-x-4">
        <!-- Like button -->
        <button
            class="flex items-center text-gray-400 dark:text-gray-500 hover:text-orange-500 dark:hover:text-orange-500">
...
<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="{{ asset('images/user-40-06.jpg') }}" width="40" height="40"
                alt="User 06" />
            <div>
                <div class="leading-tight">
    ...
    <div class="text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-5">
        ...
        <div class="relative !my-4">
            <img class="block w-full" src="{{ asset('images/feed-image-01.jpg') }}" width="590" height="332"
                alt="Feed 01" />
            <div class="absolute left-0 right-0 bottom-0 p-4 bg-black bg-opacity-25 backdrop-blur-md">
                <div class="flex items-center justify-between">
                    ...
                    <a class="text-xs font-medium text-orange-400 hover:text-orange-300" href="#0">Learn More
                        -&gt;</a>
                </div>
            </div>
        </div>
...
<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="{{ asset('images/user-40-04.jpg') }}" width="40"
                height="40" alt="User 04" />
            <div>
                <div class="leading-tight">
    ...
    <div class="mt-5 pt-3 border-t border-gray-100 dark:border-gray-700/60">
        <ul class="space-y-2 mb-3">
            ...
            <li class="p-3 bg-gray-50 dark:bg-gray-700/30 rounded">
                <div class="flex items-start space-x-3">
                    <img class="rounded-full shrink-0" src="{{ asset('images/user-32-04.jpg') }}" width="32"
                        height="32" alt="User 04" />
                    <div>
                        <div class="text-xs text-gray-500">
                            <a class="font-semibold text-gray-800 dark:text-gray-100" href="#0">Sophie Wenner</a>
                            · 44min
                        </div>
                        <div class="text-sm"><a
                                class="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400"
                                href="#0">@EricaSpriggs</a> Reading through and really enjoying "Zero to Sold" by
                            Arvid.</div>
                    </div>
                </div>
            </li>
            ...
            <li class="p-3 bg-gray-50 dark:bg-gray-700/30 rounded">
                <div class="flex items-start space-x-3">
                    <img class="rounded-full shrink-0" src="{{ asset('images/user-32-05.jpg') }}" width="32"
                        height="32" alt="User 05" />
                    <div>
                        <div class="text-xs text-gray-500">
                            <a class="font-semibold text-gray-800 dark:text-gray-100" href="#0">Kyla Scanlon</a>
                            · 1h
                        </div>
                        <div class="text-sm">Depends on the company you're running, but if I had to choose just one
                            book, it'd be The Personal MBA by Josh Kaufman.</div>
                    </div>
                </div>
            </li>
        </ul>
        ...
        <div class="flex justify-between space-x-2">
            <div class="text-sm text-gray-500 dark:text-gray-400"><span
                    class="font-medium text-gray-600 dark:text-gray-300">2</span> of <span
                    class="font-medium text-gray-600 dark:text-gray-300">67</span> comments</div>
            <button class="text-sm  font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400">View
                More Comments</button>
        </div>
        <!-- Comment form -->
        <div class="flex items-center space-x-3 mt-3">
            <img class="rounded-full shrink-0" src="{{ asset('images/user-40-02.jpg') }}" width="32"
                height="32" alt="User 02" />
            <div class="grow">
                <label for="comment-form" class="sr-only">Write a comment…</label>
                <input id="comment-form"
                    class="form-input w-full bg-gray-100 dark:bg-gray-700 border-transparent dark:border-transparent focus:bg-white dark:focus:bg-gray-800 placeholder-gray-500"
...
<div class="bg-white dark:bg-gray-950 shadow-sm rounded-xl p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="{{ asset('images/user-40-08.jpg') }}" width="40"
                height="40" alt="User 08" />
            <div>
                <div class="leading-tight">
                    <a class="text-sm font-semibold text-gray-800 dark:text-gray-100" href="#0">Margaret
                        Sullivan</a>
                </div>
    ...
    <div class="text-sm text-gray-800 dark:text-gray-100 space-y-2 mb-5">
        ...
        <div class="relative flex items-center justify-center !my-4">
            <img class="block w-full" src="{{ asset('images/feed-image-02.jpg') }}" width="590" height="332"
                alt="Feed 01" />
            <button class="absolute group">
                <svg class="w-16 h-16" width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                    <circle class="fill-white opacity-80 group-hover:opacity-100 transition" cx="32"
                        cy="32" r="32" />
                    <path class="fill-orange-500"
    ...
    <footer class="flex items-center space-x-4">
        <!-- Like button -->
        <button class="flex items-center text-orange-400 dark:text-orange-500">
            <svg class="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
                <path
                    d="M14.682 2.318A4.485 4.485 0 0011.5 1 4.377 4.377 0 008 2.707 4.383 4.383 0 004.5 1a4.5 4.5 0 00-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 000-6.364zm-1.4 4.933L8 12.247l-5.285-5A2.5 2.5 0 014.5 3c1.437 0 2.312.681 3.5 2.625C9.187 3.681 10.062 3 11.5 3a2.5 2.5 0 011.785 4.251h-.003z" />
            </svg>
            <div class="text-sm text-orange-500">2.2K</div>
        </button>
        <!-- Share button -->
        <button
            class="flex items-center text-gray-400 dark:text-gray-500 hover:text-orange-500 dark:hover:text-orange-500">
