        ...
        <div class="md:py-8">
            ...
            <div class="xl:hidden mb-6">
                <form class="relative">
                    ...
                    <input id="feed-search-mobile" class="form-input w-full pl-9 bg-white dark:bg-gray-950"
            ...
            <div
                ...
                <!-- Group 1 -->
                <div>
                    <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-3 md:sr-only">Menu
                    </div>
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap bg-white dark:bg-gray-950"
                                href="#0">
                                <svg class="shrink-0 fill-current text-orange-500 mr-2" width="16" height="16"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span class="text-sm font-medium text-orange-500">Home</span>
                            </a>
                        </li>
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                                <svg class="shrink-0 fill-current text-gray-400 dark:text-gray-500 mr-2" width="16"
                                    height="16" viewBox="0 0 16 16">
                                    <path
                                        d="M13 4a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v9.131l4.445-2.963a1 1 0 0 1 1.11 0L13 13.13V4Zm-5 8.202-5.445 3.63A1 1 0 0 1 1 15V4a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v11a1 1 0 0 1-1.555.832L8 12.202Z" />
                                </svg>
                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                                ...
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Self
                                    Development</span>
                            </a>
                        </li>
                    </ul>
