    ...
    <div class="relative px-4 sm:px-6 pb-8">
        ...
        <div class="-mt-16 mb-6 sm:mb-3">
            ...
            <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
                ...
                <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
                    <img class="rounded-full border-4 border-white dark:border-gray-900"
                        src="{{ asset('images/user-128-01.jpg') }}" width="128" height="128" alt="Avatar" />
                </div>

                <!-- Actions -->
                <div class="flex space-x-2 sm:mb-2">
                    <button
                        class="p-1.5 shrink-0 rounded-lg bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm">
        ...
        <header class="text-center sm:text-left mb-6">
            ...
            <div class="inline-flex items-start mb-2">
                ...
                <svg class="fill-current shrink-0 text-yellow-500 ml-2" width="16" height="16"
                    viewBox="0 0 16 16">
                    <path
            ...
            <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-medium whitespace-nowrap text-gray-500 dark:text-gray-400 ml-2">Milan,
                        IT</span>
                </div>
                <div class="flex items-center">
                    <svg class="fill-current shrink-0 text-gray-400 dark:text-gray-500" width="16" height="16"
                    ...
                    <a class="text-sm font-medium whitespace-nowrap text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 ml-2"
            ...
            <div class="flex-1 space-y-5 mb-8 xl:mb-0">
                ...
                <div>
                    ...
                    <div class="grid xl:grid-cols-2 gap-4">
                        ...
                        <!-- Card -->
                        <div
                            class="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                            <!-- Card header -->
                            <div class="grow flex items-center truncate mb-2">
                                ...
                                <div class="truncate">
                                    <span class="text-sm font-medium text-gray-800 dark:text-gray-100">Acme
                                        Marketing</span>
                                </div>
                            </div>
                            <!-- Card content -->
                        ...
                        <div
                            ...
                            <div class="grow flex items-center truncate mb-2">
                                <div
                                    class="w-8 h-8 shrink-0 flex items-center justify-center bg-gray-700 rounded-full mr-2">
                                    <img class="ml-1" src="{{ asset('images/icon-02.svg') }}" width="14"
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex -space-x-3 -ml-0.5">
                                    ...
                                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                        ...
                                        alt="Avatar" />
                                    <img class="rounded-full border-2 border-white dark:border-gray-800 box-content"
                                        src="{{ asset('images/avatar-01.jpg') }}" width="24" height="24"
                                        alt="Avatar" />
                                </div>
                                <!-- Link -->
                                <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li class="sm:flex sm:items-center sm:justify-between">
                                <div class="sm:grow flex items-center text-sm">
                                    ...
                                    <!-- Position -->
                                    <div>
                                        <div class="font-medium text-gray-800 dark:text-gray-100">Senior Product
                                            Designer</div>
                                ...
                                <div class="sm:ml-2 mt-2 sm:mt-0">
                                    <ul class="flex flex-wrap sm:justify-end -m-1">
                                        <li class="m-1">
                                            <button
                                                class="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-950 text-gray-500 dark:text-gray-400 transition">Marketing</button>
                                        </li>
                                        <li class="m-1">
                                            <button
                                                class="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-950 text-gray-500 dark:text-gray-400 transition">+4</button>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="sm:flex sm:items-center sm:justify-between">
                                <div class="sm:grow flex items-center text-sm">
                                    <!-- Icon -->
                                    <div class="w-8 h-8 rounded-full shrink-0 bg-orange-500 my-2 mr-3">
                                        <svg class="w-8 h-8 fill-current text-orange-50" viewBox="0 0 32 32">
                                            <path
                                    ...
                                    <!-- Position -->
                                    <div>
                                        <div class="font-medium text-gray-800 dark:text-gray-100">Product Designer
                                        </div>
                                        <div class="flex flex-nowrap items-center space-x-2 whitespace-nowrap">
                                            <div>Milan, IT</div>
                                            <div class="text-gray-400 dark:text-gray-600">·</div>
