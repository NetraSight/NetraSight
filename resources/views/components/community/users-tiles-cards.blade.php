<div class="col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    <div class="flex flex-col h-full">
                ...
                <header>
                    <div class="flex mb-2">
                        <a class="relative inline-flex items-start mr-5" href="#0">
                            <div class="absolute top-0 right-0 -mr-2 bg-white dark:bg-gray-700 rounded-full shadow"
                                aria-hidden="true">
                        ...
                        <div class="mt-1 pr-1">
                            ...
                            <div class="flex items-center"><span
                                    class="text-sm font-medium text-gray-400 dark:text-gray-500 -mt-0.5 mr-1">-&gt;</span>
        ...
        <div>
            <div class="flex divide-x divide-gray-100 dark:divide-gray-700/60">
                <a class="block flex-1 text-center text-sm text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 font-medium px-3 py-4"
                    href="{{ route('messages') }}">
                ...
                <a class="block flex-1 text-center text-sm text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-200 font-medium px-3 py-4 group"
                    href="{{ route('account') }}">
                    <div class="flex items-center justify-center">
                        <svg class="fill-current text-gray-400 dark:text-gray-600 group-hover:text-gray-500 shrink-0 mr-2"
