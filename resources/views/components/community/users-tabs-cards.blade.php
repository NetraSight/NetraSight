<div class="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    <div class="flex flex-col h-full">
        ...
        <!-- Card footer -->
        <div>
            <a class="block text-center text-sm text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 font-medium px-3 py-4"
                href="{{ route('messages') }}">
