<div class="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-950 shadow-sm rounded-xl">
    <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        ...
        <div class="relative ml-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            ...
            <div class="z-10 absolute bottom-full left-1/2 -translate-x-1/2">
                <div class="min-w-72 bg-white dark:bg-gray-950 dark:text-gray-100 border border-gray-200 dark:border-gray-600 px-3 py-2 rounded-lg shadow-lg overflow-hidden mb-2"
