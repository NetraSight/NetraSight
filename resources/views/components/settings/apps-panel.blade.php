    ...
    <div class="p-6">
            ...
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700/60">
                <ul class="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                    <li
                        ...
                        <a class="text-orange-500 whitespace-nowrap" href="#0">View All</a>
                    </li>
                    <li
                        class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
        ...
        <section class="pb-6 border-b border-gray-200 dark:border-gray-700/60">
            <div class="grid grid-cols-12 gap-6">
                <!-- Card 1 -->
                <div
                    class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-lg">
                    <!-- Card content -->
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header class="flex items-center mb-4">
                                <div class="w-10 h-10 rounded-full shrink-0 bg-orange-500 mr-3">
                        ...
                        <footer class="mt-4">
                            <div class="flex flex-wrap justify-between items-center">
                                ...
                                <!-- Right side -->
                                <button
                                    class="btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm flex items-center">
        ...
        <section>
            <h3 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mt-6 mb-5">Trending Categories
            </h3>
            <div class="grid grid-cols-12 gap-6">
                <!-- Card 1 -->
                <div
                    class="col-span-full xl:col-span-4 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-lg">
                    <!-- Card content -->
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-gray-800 dark:text-gray-100 font-semibold mb-1">Programming
                                </h3>
                            </header>
                        </div>
                        <!-- Card footer -->
                ...
                <div
                    ...
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-gray-800 dark:text-gray-100 font-semibold mb-1">Digital
                                    Marketing</h3>
                            </header>
                        </div>
                        <!-- Card footer -->
                ...
                <div
                    ...
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
                                <h3 class="text-lg text-gray-800 dark:text-gray-100 font-semibold mb-1">Music & Audio
                                </h3>
                            </header>
                        </div>
                        <!-- Card footer -->
