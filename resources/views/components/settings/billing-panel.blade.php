<div class="grow">
    ...
    <div class="p-6 space-y-6">
        <div>
            ...
            <div class="text-sm">This workspace’s Basic Plan is set to <strong class="font-medium">$34</strong> per month
                and will renew on <strong class="font-medium">July 9, 2024</strong>.</div>
        </div>
        ...
        <section>
            ...
            <ul>
                <li
                    class="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
                    <!-- Left -->
                ...
                <li
                    ...
                    <!-- Right -->
                    <div class="text-sm text-gray-600 dark:text-gray-400 ml-4">
                        <span class="mr-3">hello@netrasight.com</span>
                        <a class="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400"
                            href="#0">Edit</a>
                    </div>
                </li>
        ...
        <section>
            ...
            <table class="table-auto w-full dark:text-gray-400">
                ...
                <tbody class="text-sm">
                    <!-- Row -->
                    <tr
                        class="flex flex-wrap md:table-row md:flex-no-wrap border-b border-gray-200 dark:border-gray-700/60 py-2 md:py-0">
                        ...
                        <td class="w-full block md:w-auto md:table-cell py-0.5 md:py-2">
                            <div class="text-right flex items-center md:justify-end">
                                <a class="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400"
                                    href="#0">HTML</a>
                                <span class="block w-px h-4 bg-gray-200 dark:bg-gray-700 mx-2"
