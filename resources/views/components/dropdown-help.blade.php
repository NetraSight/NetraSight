...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div class="origin-top-right z-10 absolute top-full min-w-44 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 {{ $align === 'right' ? 'right-0' : 'left-0' }}"
        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-orange-500 hover:text-orange-600 dark:hover:text-orange-400 flex items-center py-1 px-3"
                    href="https://netrasight.com" @click="open = false" @focus="open = true" @focusout="open = false">
